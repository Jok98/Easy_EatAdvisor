 ...
 * La classe permette di  ricercare(btnCerca) i ristoranti tramite nome o tipologia gli eventuali risultati vengono poi mostrati<br>
 * nella result_list nella quale poi l'utente potrà scegliere un singolo ristorante di cui visualizzare le informazioni(btnInfo) e le recensioni<br>
 * se l'utente ha effettuato l'accesso al frame LogIn tramite credenziali avrà anche la possibilità di effettuare una recensione(btnInvia)
 */
public class LogIn {
